function [ output_args ] = inpainting( img, fillRegion, out_path, f, gap )
...
nameout = [out_path, '_out', setting_name];
nameout1 = [out_path, '_order', setting_name];
...
L = int16(10);  % amount of patches to take into account
ITER = 10;
fprintf('gap = %i\n', gap)
