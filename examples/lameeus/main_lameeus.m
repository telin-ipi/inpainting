...
%% variables
% folder_in = '/scratch/lameeus/data/ghent_altar/altarpiece_close_up/finger/';
% input_name = 'hand_cleaned.tif';
% mask_name = 'crack_cnn.png';
% out_name = 'hand_inpainting';

folder_in = '/home/lameeus/data/ghent_altar/input/19_hand/';
input_name = '19_hand_clean.tif';

folder_mask = '/home/lameeus/data/ghent_altar/classification/';
mask_name = 'class_hand_small_v1.tif';
out_name = 'hand_inpainting';
...
if version == 0
    folder_out = '/home/lameeus/data/ghent_altar/inpainting/hand/v0/';
    f = 4;      % default is 8, 
    gap = 2;    % default is 6, 
    ext = 2*f;
end
...
%% loading
mask_path = [folder_mask, mask_name];
